...
const PORT = 3000; //port for express to listen
...
app.get("/getpokedata/:type", (req, res) => {
  ...
  const startIndex = Number(req.query?.start ?? 1); //Extract starting index from query params. If not present, default to 1
